...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = "CONVOLUTIONAL_GRAPH_SSM"
# Model name
_C.MODEL.NAME = "convolutional_graph_ssm"
...
# CONVOLUTIONAL_GRAPH_SSM parameters
_C.MODEL.CONV_GRAPH_SSM = CN()
_C.MODEL.CONV_GRAPH_SSM.DEPTHS = [4, 4, 18, 4]
_C.MODEL.CONV_GRAPH_SSM.GROUPS = [4, 8, 16, 32]
_C.MODEL.CONV_GRAPH_SSM.CHANNELS = 64
_C.MODEL.CONV_GRAPH_SSM.LAYER_SCALE = None
_C.MODEL.CONV_GRAPH_SSM.OFFSET_SCALE = 1.0
_C.MODEL.CONV_GRAPH_SSM.MLP_RATIO = 4.0
_C.MODEL.CONV_GRAPH_SSM.CORE_OP = "DCNv3"
_C.MODEL.CONV_GRAPH_SSM.POST_NORM = False
_C.MODEL.CONV_GRAPH_SSM.RES_POST_NORM = False
_C.MODEL.CONV_GRAPH_SSM.DW_KERNEL_SIZE = None
_C.MODEL.CONV_GRAPH_SSM.USE_CLIP_PROJECTOR = False
_C.MODEL.CONV_GRAPH_SSM.LEVEL2_POST_NORM = False
_C.MODEL.CONV_GRAPH_SSM.LEVEL2_POST_NORM_BLOCK_IDS = None
_C.MODEL.CONV_GRAPH_SSM.CENTER_FEATURE_SCALE = False
_C.MODEL.CONV_GRAPH_SSM.REMOVE_CENTER = False
