    ...
    def forward(self, input_tensor, cur_state):
        ...
        if self.training == False:
            ...
            with open(file_path, "a") as f:
                f.write(
                    f"sparse_rate: tot {sparse_rate} inp {sparse_rate_inp} delta {sparse_rate_delta} size {combined.shape}\n"
                )
