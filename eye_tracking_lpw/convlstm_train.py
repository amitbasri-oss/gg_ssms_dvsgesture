...
if __name__ == "__main__":
    run = wandb.init(project="graph_ssm_train")

    DATA_DIR_ROOT = "/data/scratch2/nzubic/LongSeqFlow/event_based/datasets"
    ...
    model = ConvolutionalLSTM(height, width, input_dim)
    print(model)
